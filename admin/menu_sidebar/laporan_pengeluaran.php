...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="">Laporan Pengeluaran</a></li>
    </ol>
  </section>
    ...
    <div class="row">
      <section class="col-lg-10 col-lg-offset-1">
        <div class="box box-info">
          ...
          <div class="box-body">
            <form action="<?php echo BASE_URL_ADM_MENU; ?>laporan_pdf_pengeluaran.php" method="GET" target="_blank" class="form-horizontal">
